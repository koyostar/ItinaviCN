...
exports.COUNTRY_TIMEZONES = exports.COMMON_TIMEZONES = exports.CITIES = exports.COUNTRIES = void 0;
exports.searchLocations = searchLocations;
exports.getDisplayName = getDisplayName;
exports.findLocationKey = findLocationKey;
 ...
 */
function getDisplayName(locationData, language) {
    return language === "zh" ? locationData.zh : locationData.en;
}
/**
 * Find standardized key from either English or Chinese input
 */
function findLocationKey(input, locations) {
    // Direct key match
    if (locations[input])
        return input;
    // Search for match in English or Chinese
    const found = Object.entries(locations).find(([key, data]) => key.toLowerCase() === input.toLowerCase() ||
...
function getTimezoneForCountry(country) {
    return exports.COUNTRY_TIMEZONES[country] || "Asia/Shanghai";
}
/**
